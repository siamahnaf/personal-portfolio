...
const Content = () => {
    return (
        <div className="pt-48 xl:pt-80 lg:pt-48 md:pt-24 xs:pt-8 xxs:pt-5">
            ...
            <p className="text-[17px] xs:text-[17px] xxs:text-[15px] font-medium mb-10 w-11/12 sm:w-11/12 xxs:w-full">
