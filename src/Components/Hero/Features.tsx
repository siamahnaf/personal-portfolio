...
const Features = () => {
    ...
    return (
        <div className="py-6">
            ...
            <div className="grid grid-cols-8 xl:grid-cols-9 lg:grid-cols-8 md:grid-cols-6 smd:grid-cols-5 msm:grid-cols-4 sm:grid-cols-3 xs:grid-cols-3 xxs:grid-cols-2 gap-4">
